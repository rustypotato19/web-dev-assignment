...
export default function Profile() {
  ...
  if (!ctx) {
    return (
      <MyError ErrorCode={1002} ErrorMessage="Context failed to initialise." />
    );
  }

  if (!username) {
    return <MyError ErrorCode={1003} ErrorMessage="Username not found." />;
  }
        ...
        <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col lg:flex-row items-center lg:items-end gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-4 mt-2">
              ...
              <div className="bg-white/10 px-4 py-2 rounded-xl">
                <p className="text-sm opacity-80">Lists</p>
